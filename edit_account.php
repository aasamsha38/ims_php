...
if (isset($_POST['submit'])) {
  ...
  if ($photo->process_user($user_id)) {
    ...
    var_dump($_FILES['file_upload'], $photo->errors); // Debug file upload
    exit;
  }
}
        ...
        <form class="general--form access__form" action="edit_account.php" method="POST" enctype="multipart/form-data">
          <div class="profile__img">
            <!-- <div class="form-group">
              <input type="file" name="file_upload" multiple="multiple" class="primary-line"/>
              <input type="hidden" name="user_id" value="<?php echo $user['id'];?>">
              <input type="submit" name="submit" class="button primary-tint" value="Upload">
            </div> -->
